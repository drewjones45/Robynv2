...
##actual test data
robyn_dailysample_v6_rdata <- read.csv("C:/Users/andrew/Documents/GitHub/Robynv2/R/data/robyn_dataset_daily_v6.csv")
save(robyn_dailysample_v6_rdata, file="C:/Users/andrew/Documents/GitHub/Robynv2/R/data/robyn_dailysample_v6_rdata.RData")
...
InputCollect <- robyn_inputs(
  ...
  window_start = "2022-07-12",
  window_end = "2023-10-24",
...
hyperparameters <- list(
  fb_adv_alphas = c(0.5, 3),
  fb_adv_gammas = c(0.3, 1),
  fb_adv_thetas = c(0.3, 0.8),
  fb_awareness_alphas = c(0.5, 3),
  fb_awareness_gammas = c(0.3, 1),
  fb_awareness_thetas = c(0.3, 0.8),
  fb_consideration_alphas = c(0.5, 3),
  fb_consideration_gammas = c(0.3, 1),
  fb_consideration_thetas = c(0.3, 0.8),
  fb_intent_alphas = c(0.5, 3),
  fb_intent_gammas = c(0.3, 1),
  fb_intent_thetas = c(0.3, 0.8),
  fb_loyalty_alphas = c(0.5, 3),
  fb_loyalty_gammas = c(0.3, 1),
  fb_loyalty_thetas = c(0.3, 0.8),
  ga_brand_alphas = c(0.5, 3),
  ga_brand_gammas = c(0.3, 1),
  ga_brand_thetas = c(0.3, 0.8),
  ga_other_alphas = c(0.5, 3),
  ga_other_gammas = c(0.3, 1),
  ga_other_thetas = c(0.3, 0.8),
  ga_nonbrand_alphas = c(0.5, 3),
  ga_nonbrand_gammas = c(0.3, 1),
  ga_nonbrand_thetas = c(0.3, 0.8),
  ga_shoppmax_alphas = c(0.5, 3),
  ga_shoppmax_gammas = c(0.3, 1),
  ga_shoppmax_thetas = c(0.3, 0.8),
...
print(OutputCollect)
select_model <- "5_77_5" # Pick one of the models from OutputCollect to proceed
...
AllocatorCollect1 <- robyn_allocator(
  ...
  total_budget = 1300000, # When NULL, default is total spend in date_range
...
AllocatorCollect2 <- robyn_allocator(
  ...
  OutputCollect = OutputCollect,
  select_model = select_model,
  date_range = "last_4", # Last 10 periods, same as c("2018-10-22", "2018-12-31")
  total_budget = 1300000, # Total budget for date_range period simulation
  channel_constr_low = c(0.8, 1, 0.7, 0.8, 0.8, 0.9, 0.9, 1, 1, .8, 1, .8, 1),
  channel_constr_up = c(1.2, 1, 1.5, 1.3, 1.3, 1.3, 1.3, 1, 1, 1.3, 1, 1.5, 5),
  channel_constr_multiplier = 1, # Customise bound extension for wider insights
  scenario = "max_response",
  export = create_files
)
