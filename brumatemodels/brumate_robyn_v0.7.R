...
##actual test data
robyn_dailysample_v5_rdata <- read.csv("C:/Users/andrew/Documents/GitHub/Robynv2/R/data/robyn_dataset_daily_v5.csv")
save(robyn_dailysample_v5_rdata, file="C:/Users/andrew/Documents/GitHub/Robynv2/R/data/robyn_dailysample_v5_rdata.RData")
data("robyn_dailysample_v5_rdata")
...
InputCollect <- robyn_inputs(
  ...
  paid_media_spends = c("facebook_cost", "google_ads_cost", "tiktok_cost", "influencer_cost", "other_cost"), # mandatory input
  paid_media_vars = c("facebook_cost", "google_ads_cost", "tiktok_cost", "influencer_cost", "other_cost"), # mandatory.
...
print(OutputCollect)
select_model <- "4_100_3" # Pick one of the models from OutputCollect to proceed
