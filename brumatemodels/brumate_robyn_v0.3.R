...
InputCollect <- robyn_inputs(
  ...
  paid_media_spends = c("facebook_cost", "google_ads_cost", "bing_ads_cost", "tiktok_cost", "influencer_cost", "tiktok_influencer_cost", "tatari_cost", "mntn_cost", "dm_cost"), # mandatory input
  paid_media_vars = c("facebook_cost", "google_ads_cost", "bing_ads_cost", "tiktok_cost", "influencer_cost", "tiktok_influencer_cost", "tatari_cost", "mntn_cost", "dm_cost"), # mandatory.
  # paid_media_vars must have same order as paid_media_spends. Use media exposure metrics like
  # impressions, GRP etc. If not applicable, use spend instead.
  organic_vars = c("email_campaign_delivery", "organic_impressions"), # marketing activity without media spend
...
hyperparameter_range <- 0.2

lower_bound <- 1 - hyperparameter_range
upper_bound <- 1 + hyperparameter_range

hyperparameters <- list(
  dm_cost_alphas = c(0.9416 * lower_bound, 0.9416 * upper_bound),
  dm_cost_gammas = c(0.9 * lower_bound , 1),
  dm_cost_shapes = c(6.0 * lower_bound , 6.0 * upper_bound),
  dm_cost_scales = c(0.005 * lower_bound, 0.005 * upper_bound),
  tatari_cost_alphas = c(2.0 * lower_bound, 2.0 * upper_bound),
  tatari_cost_gammas = c(0.15 * lower_bound, 0.15 * upper_bound),
  tatari_cost_shapes = c(0.10 * lower_bound, 0.10 * upper_bound),
  tatari_cost_scales = c(0.005 * lower_bound, 0.005 * upper_bound),
  mntn_cost_alphas = c(2.0 * lower_bound, 2.0 * upper_bound),
  mntn_cost_gammas = c(0.9 * lower_bound, 1),
  mntn_cost_shapes = c(2.8332 * lower_bound, 2.8332 * upper_bound),
  mntn_cost_scales = c(0.005 * lower_bound,0.005 * upper_bound),
  facebook_cost_alphas = c(2.0 * lower_bound, 2.0 * upper_bound),
  facebook_cost_gammas = c(0.9 * lower_bound, 1),
  facebook_cost_shapes = c(2.1785 * lower_bound, 2.1785 * upper_bound),
  facebook_cost_scales = c(0.005 * lower_bound, 0.005 * upper_bound),
  google_ads_cost_alphas = c(2.0 * lower_bound, 2.0 * upper_bound),
  google_ads_cost_gammas = c(0.3393 * lower_bound, 0.3393 * upper_bound),
  google_ads_cost_shapes = c(2.1785 * lower_bound, 2.1785 * upper_bound),
  google_ads_cost_scales = c(0.005 * lower_bound, 0.005 * upper_bound),
  bing_ads_cost_alphas = c(2.0 * lower_bound, 2.0 * upper_bound),
  bing_ads_cost_gammas = c(0.5645 * lower_bound, 0.5645 * upper_bound),
  bing_ads_cost_shapes = c(2.2010 * lower_bound, 2.2010 * upper_bound),
  bing_ads_cost_scales = c(0.005 * lower_bound, 0.005 * upper_bound),
  tiktok_cost_alphas = c(0.3 * lower_bound, 0.3 * upper_bound), #alt scenario 0.9
  tiktok_cost_gammas = c(0.45 * lower_bound, 0.45 * upper_bound),   #alt scenario 0.45
  tiktok_cost_shapes = c(2.3446 * lower_bound, 2.3446 * upper_bound),
  tiktok_cost_scales = c(0.005 * lower_bound,0.005 * upper_bound),
  influencer_cost_alphas = c(2.0 * lower_bound, 2.0 * upper_bound),
  influencer_cost_gammas = c(0.9 * lower_bound, 1),
  influencer_cost_shapes = c(1.4274 * lower_bound, 1.4274 * upper_bound),
  influencer_cost_scales = c(0.017 * lower_bound, 0.017 * upper_bound),
  tiktok_influencer_cost_alphas = c(2.0 * lower_bound, 2.0),
  tiktok_influencer_cost_gammas = c(0.2524 * lower_bound, 0.2524 * upper_bound),
  tiktok_influencer_cost_shapes = c(4.2163 * lower_bound, 4.2163 * upper_bound),
  tiktok_influencer_cost_scales = c(0.005 * lower_bound, 0.005 * upper_bound),
  #sms_cost_alphas = c(2.0 * lower_bound, 2.0 * upper_bound),
  #sms_cost_gammas = c(0.5645 * lower_bound, 0.5645 * upper_bound),
  #sms_cost_shapes = c(1.4667 * lower_bound, 1.4667 * upper_bound),
  #sms_cost_scales = c(0.005 * lower_bound, 0.005 * upper_bound),
  #cj_cost_alphas = c(0.9416 * lower_bound, 0.9416 * upper_bound),
  #cj_cost_gammas = c(0.4595 * lower_bound, 0.4595 * upper_bound),
  #cj_cost_shapes = c(1.00 * lower_bound, 1.00 * upper_bound),   #alt scenario 1.6423
  #cj_cost_scales = c(0.005 * lower_bound, 0.005 * upper_bound),
  # fig_cost_alphas = c(2.0 * lower_bound, 2.0 * upper_bound),
  # fig_cost_gammas = c(0.5645 * lower_bound, 0.5645 * upper_bound),
  # fig_cost_shapes = c(1.9762 * lower_bound, 1.9762 * upper_bound),
  # fig_cost_scales = c(0.005 * lower_bound, 0.005 * upper_bound),
  # linkby_cost_alphas = c(2.0 * lower_bound, 2.0 * upper_bound),
  # linkby_cost_gammas = c(0.6797 * lower_bound, 0.6797 * upper_bound),
  # linkby_cost_shapes = c(6.0 * lower_bound, 6.0 * upper_bound),
  # linkby_cost_scales = c(0.005 * lower_bound, 0.005 * upper_bound),
  # sms_sends_alphas = c(2.0 * lower_bound, 2.0 * upper_bound),
  # sms_sends_gammas = c(0.5645 * lower_bound, 0.5645 * upper_bound),
  # sms_sends_shapes = c(1.4667 * lower_bound, 1.4667 * upper_bound),
  # sms_sends_scales = c(0.005 * lower_bound, 0.005 * upper_bound),
  email_campaign_delivery_alphas = c(2.0 * lower_bound, 2.0 * upper_bound),
  email_campaign_delivery_gammas = c(0.9 * lower_bound, 1),
  email_campaign_delivery_shapes = c(1.8188 * lower_bound, 1.8188 * upper_bound),
  email_campaign_delivery_scales = c(0.005 * lower_bound, 0.005 * upper_bound),
  organic_impressions_alphas = c(2.0 * lower_bound, 2.0 * upper_bound),
  organic_impressions_gammas = c(0.7035 * lower_bound, 0.7035 * upper_bound),
  organic_impressions_shapes = c(2.3824 * lower_bound, 2.3824 * upper_bound),
  organic_impressions_scales = c(0.005 * lower_bound, 0.005 * upper_bound),
  train_size = c(0.5, 0.8)
)
